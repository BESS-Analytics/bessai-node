...
export class WorkflowResource {
  ...
  async create(params: WorkflowCreateParams): Promise<WorkflowCreateResponse> {
    return this.client.post<WorkflowCreateResponse>("/v1/workflows", {
  ...
  async generate(params: WorkflowGenerateParams): Promise<GenerateResponse> {
    return this.client.post<GenerateResponse>("/v1/workflows/generate", {
      json: params as unknown as Record<string, unknown>,
    });
  }
  ...
  async list(
    ...
    return this.client.get<PaginatedResponse<WorkflowResponse>>("/v1/workflows", {
  ...
  async update(
    ...
    return this.client.patch(`/v1/workflows/${workflowId}`, {
      json: params as unknown as Record<string, unknown>,
    });
  }
  ...
  async delete(workflowId: string): Promise<Record<string, unknown>> {
    return this.client.delete(`/v1/workflows/${workflowId}`);
  }
  ...
  async refine(
    ...
    return this.client.post<GenerateResponse>(`/v1/workflows/${workflowId}/refine`, {
      json: params as unknown as Record<string, unknown>,
    });
  }
  ...
  async restore(
    ...
    return this.client.post<WorkflowDetailResponse>(`/v1/workflows/${workflowId}/restore`, {
      json: { version },
    });
  }
  ...
  async saveSecrets(
    ...
    return this.client.post(`/v1/workflows/${workflowId}/secrets`, {
      json: params as unknown as Record<string, unknown>,
    });
  }
  ...
  async getCredentialSchema(
    ...
    return this.client.get<CredentialSchemaResponse[]>(
      `/v1/workflows/${workflowId}/credential-schema`
    );
  }
  ...
  async execute(
    ...
    return this.client.post<ExecuteResponse>(`/v1/workflows/${workflowId}/execute`, {
      json: (params as unknown as Record<string, unknown>) ?? {},
    });
  }
  ...
  async listExecutions(
    ...
    return this.client.get<PaginatedResponse<WorkflowExecutionResponse>>(`/v1/workflows/${workflowId}/executions`, {
  ...
  async export(workflowId: string): Promise<Record<string, unknown>> {
    return this.client.get(`/v1/workflows/${workflowId}/export`);
  }

  /** Import a workflow from exported JSON. */
  async importWorkflow(data: Record<string, unknown>): Promise<WorkflowResponse> {
    return this.client.post<WorkflowResponse>("/v1/workflows/import", {
      json: data,
    });
  }
  ...
  async linkAgent(
    ...
    return this.client.post<AgentWorkflowLinkResponse>(
      `/v1/workflows/${workflowId}/agents/${agentId}`,
      { json: (params as unknown as Record<string, unknown>) ?? {} }
    );
  }
  ...
  async listAgents(workflowId: string): Promise<AgentWorkflowListItem[]> {
    return this.client.get<AgentWorkflowListItem[]>(
      `/v1/workflows/${workflowId}/agents`
    );
  }
  ...
  async setSchedule(
    ...
    return this.client.post<ScheduleStatusResponse>(`/v1/workflows/${workflowId}/schedule`, {
      json: config,
    });
  }
  ...
  async removeSchedule(workflowId: string): Promise<Record<string, unknown>> {
    return this.client.delete(`/v1/workflows/${workflowId}/schedule`);
  }
  ...
  async listSchedules(): Promise<ScheduleStatusResponse[]> {
    return this.client.get<ScheduleStatusResponse[]>("/v1/workflows/schedules");
  }
}
